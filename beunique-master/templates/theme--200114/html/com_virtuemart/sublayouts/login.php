    ...
    if ($this->order  ) {
      ...
      <div class="order-view ttr_cart_content">
        ...
        <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
          ...
          <div class="width30 floatleft col-xl-3 col-lg-3 col-md-3 col-xs-6 col-xs-6 col-6" id="com-form-order-number">
          ...
          <div class="width30 floatleft col-xl-3 col-lg-3 col-md-3 col-xs-6 col-xs-6 col-6" id="com-form-order-pass">
          ...
          <div class="width30 floatleft col-xl-4 col-lg-4 col-md-4 col-xs-6 col-xs-6 col-6" id="com-form-order-submit">         
...
<?php   }
    ...
    <form id="com-form-login" action="<?php echo $url; ?>" method="post" name="com-login" >
      <fieldset class="userdata ttr_cart_content">
        ...
        <?php }   ?>
        <div class="row">
        <div class="width30 floatleft col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12" id="com-form-login-username">
...
<!--col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12-->
        <div class="width30 floatleft col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12" id="com-form-login-password">
        ...
        <div class="width30 floatleft col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12" id="com-form-login-remember">
      ...
      <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 forgotpassword">
