...
foreach ($viewData['products'] as $type => $products ) { 
	...
	<div class="horizontal-separator"></div>
	 ...
	 ?> 		
	<div class="col-xl-<?php echo $class_suffix_lg;?> col-lg-<?php echo $class_suffix_lg;?> col-md-<?php echo $class_suffix_md;?> col-xs-<?php echo $class_suffix_xs;?> col-sm-<?php echo $class_suffix_xs;?> col-<?php echo $class_suffix_xs;?>">
	...
	elseif(($columncounter) % $md == 0)  
 	{?> 
		<div style="clear: both;" class="visible-md-block d-md-block"></div> 
	<?php 
	} 
