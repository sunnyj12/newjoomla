...
<?php if (VmConfig::get ('oncheckout_show_steps', 1) ){
	...
	<div class="vm-cart-header-container">
		<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 vm-cart-header">
			<h1 class="ttr_page_title"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TITLE'); ?></h1>
			<div class="payments-signin-button" ></div>
		</div>		
		<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 vm-continue-shopping">
