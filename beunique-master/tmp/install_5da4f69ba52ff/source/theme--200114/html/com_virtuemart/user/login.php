    ...
    if ($this->order  ) {
      ...
      <div class="order-view ttr_cart_content">
        ...
        <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
          ...
          <div class="width30 floatleft col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-6 col-6" id="com-form-order-number">
          ...
          <div class="width30 floatleft col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-6 col-6" id="com-form-order-pass">
          ...
          <div class="width30 floatleft col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6" id="com-form-order-submit">         
