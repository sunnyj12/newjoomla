...
<div id="cpanel">
	<div class="icon">
		<a href="index.php?option=com_creativecontactform&view=submissions" title="<?php echo JText::_( 'COM_CREATIVECONTACTFORM_SUBMENU_SUBMISSIONS' ); ?>">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
						<img src="components/com_creativecontactform/assets/images/submissions.png" width="48" /><br />
						<?php echo JText::_( 'COM_CREATIVECONTACTFORM_SUBMENU_SUBMISSIONS' ); ?>
					</td>
				</tr>
			</table>
		</a>
